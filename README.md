...
- [LubanCat/README.md](LubanCat/README.md)：LubanCat-5 V2 的 USB 复合设备、主机共享网络和 NoMachine 无头桌面。
- [examples/README.md](examples/README.md)：已验证的联合仿真实验与 LubanCat 跨电脑复用教程，包含操作步骤、判据与历史证据。
